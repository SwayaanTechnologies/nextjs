...
* [**16. CRUD from next.js to Apollo Client**](#16.-crud-from-next.js-to-apollo-client)
...
export const metadata: Metadata = {
  title: {
    default: "Next.js Tutorial – Swayaan",
    template: "%s | Swayaan",
  },
};
```
...
## **16. CRUD from next.js to Apollo Client**

This guide walks you through creating a simple Next.js App Router project that performs CRUD operations using Apollo Client.
...
Then, update your resolver to handle the new mutations:
